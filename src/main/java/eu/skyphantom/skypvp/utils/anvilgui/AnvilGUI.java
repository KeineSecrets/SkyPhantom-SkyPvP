package eu.skyphantom.skypvp.utils.anvilgui;
...
public class AnvilGUI {
	 ...
	 */
	private final Plugin plugin = SkyPvP.getInstance();
	/**
	...
	public static class Builder {
		...
		public AnvilGUI open(Player player) {
			...
			return new AnvilGUI(this.plugin, player, title, itemText, itemLeft, itemRight, preventClose, closeListener, inputLeftClickListener, inputRightClickListener, completeFunction);
		}
