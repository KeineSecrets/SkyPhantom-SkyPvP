...
public class Gutscheine {
    ...
    public static ItemStack getTokens(double value) {
        ...
        display = display.replace("#", (new DecimalFormat("#,###.##").format(value).replace(",", ".").replace(".", "§8'§6")));
    ...
    public static double getTokens(ItemStack itemStack) {
        ...
        double tokens = Double.parseDouble(itemStack.getItemMeta().getDisplayName().replace("§8▎ §a§lGUTSCHEIN§8 ▪ §6", "").replace("§8'§6", "").replace(" Tokens", ""));
